...
public class Main{
        ...
        do {
            ...
            switch (anwser){
                ...
                case 3:
                    ...
                    if (firstTarif < secondTarif) {
                        System.out.println("Мы советуем вам УСН доходы");
                        outputCalcs(firstTarif, secondTarif);
                    } else if (firstTarif > secondTarif) {
                        System.out.println("Мы советуем вам УСН доходы минус расходы");
                        outputCalcs(firstTarif, secondTarif);
                    } else {
                        System.out.println("Можете выбрать любую систему налогообложения");
                        System.out.println("Ваш налог составит: " + firstTarif);
                    }
                    break;
                default:
                    if (end){
    ...
    public static void outputCalcs(int firstTarif, int secondTarif) {
